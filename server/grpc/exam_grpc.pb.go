...
type ExamServiceClient interface {
	ListExams(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListExamResponse, error)
...
func (c *examServiceClient) ListExams(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListExamResponse, error) {
	out := new(ListExamResponse)
...
func (c *examServiceClient) GetExam(ctx context.Context, in *GetExamRequest, opts ...grpc.CallOption) (*Exam, error) {
	out := new(Exam)
	err := c.cc.Invoke(ctx, "/speakingExam.ExamService/getExam", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExamServiceServer interface {
	ListExams(context.Context, *empty.Empty) (*ListExamResponse, error)
...
func (UnimplementedExamServiceServer) ListExams(context.Context, *empty.Empty) (*ListExamResponse, error) {
...
func _ExamService_GetExam_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/speakingExam.ExamService/getExam",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
